...
const mockTeams = [
  { team: "Brazil", matches_played: 100, goals_for: 250, goals_against: 80, wins: 70, losses: 10, draws: 20, points: 230, win_rate: 70.0, unique_countries: 15 },
  { team: "Germany", matches_played: 90, goals_for: 210, goals_against: 75, wins: 60, losses: 15, draws: 15, points: 195, win_rate: 66.67, unique_countries: 12 },
];
